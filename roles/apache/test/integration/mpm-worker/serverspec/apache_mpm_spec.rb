...
describe file('/etc/apache2/mods-enabled/worker.conf') do
    it { should be_symlink }
    it { should be_linked_to '../mods-available/worker.conf' }
    it { should be_owned_by 'root' }
    it { should be_mode 777 }
end
describe file('/etc/apache2/mods-available/worker.conf') do
    it { should be_file }
    it { should be_owned_by 'root' }
...
describe file('/etc/apache2/mods-available/worker.conf'), :if => ! isApache24?() do
    [
      'MaxClients          150',
